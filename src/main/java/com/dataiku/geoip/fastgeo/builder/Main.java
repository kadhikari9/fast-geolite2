...
public class Main {
	...
	public static void main(String[] args) throws IOException,
		...
		String input = "C:/Users/Administrator/Desktop/ff2/GeoLite2-City.mmdb";
		String output = "C:/Users/Administrator/Desktop/ff2/FastGeoLite2-City.mmdb";
			...
			for (InetAddress addr : addressesInet) {
				...
				if (n != null) {
					...
					for (int i = 0; i < subdivisions.size(); i++) {
						...
						hashMMDB = 31
								* hashMMDB
								+ subdivisions.get(i).path("iso_code").asText()
										.hashCode();
